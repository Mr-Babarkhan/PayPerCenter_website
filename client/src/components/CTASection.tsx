...
export default function CTASection() {
  return (
    <section className="w-full py-24 md:py-32 bg-gradient-to-br from-primary via-primary to-primary/90 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <div className="pt-4">
            <Button
              size="lg"
              variant="secondary"
              className="text-lg font-bold px-12 py-7 bg-white hover:bg-white/90 text-primary shadow-2xl hover:scale-105 transition-transform"
